...
@section('content')
    <div class="portlet">
        <div class="portlet-title">
            ...
            <div class="actions">
                <a href="{{ route('admin.categories-of-images.create') }}" class="btn default yellow-stripe">
        ...
        <div class="portlet-body">
            <div class="table-container">
                @include('admin.partials._datatables', ['id'=>$datatableId, 'url'=>'api/categories-of-images'])
            </div>
        </div>
    </div>
@append
